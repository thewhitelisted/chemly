      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 py-3 rounded-2xl shadow-xl bg-white/60 backdrop-blur-lg border border-[#e0e0e0]/70 ring-1 ring-[#0097b2]/10 transition-all duration-300">
        ...
        <div className="hidden md:flex gap-4">
          ...
          {user ? (
            <Link
              to="/app"
              className="relative px-5 py-2 rounded-full font-semibold text-base transition-all duration-450 ease-[cubic-bezier(0.4,0,0.2,1)] bg-gradient-to-r from-[#007d40] to-[#0097b2] text-[#fffae2] shadow-lg hover:shadow-2xl hover:scale-105"
              style={{ transitionProperty: 'background, color, box-shadow, transform' }}
            >
            ...
            <Link
              to="/app"
              className="relative px-5 py-2 rounded-full font-semibold text-base transition-all duration-450 ease-[cubic-bezier(0.4,0,0.2,1)] text-[#007d40] hover:text-[#fffae2] hover:bg-gradient-to-r hover:from-[#007d40] hover:to-[#0097b2] hover:shadow-2xl hover:scale-105"
              style={{ transitionProperty: 'background, color, box-shadow, transform' }}
            >
        ...
        {menuOpen && (
          <div className="md:hidden absolute left-0 right-0 mx-2 mt-2 rounded-2xl shadow-2xl bg-white/90 backdrop-blur-lg border border-[#e0e0e0]/70 ring-1 ring-[#0097b2]/10 flex flex-col items-center py-4 z-40 animate-fade-in-up gap-2">
            ...
            {user ? (
              <Link
                to="/app"
                className="w-11/12 text-center py-3 rounded-full text-lg font-semibold bg-gradient-to-r from-[#007d40] to-[#0097b2] text-[#fffae2] shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-450 ease-[cubic-bezier(0.4,0,0.2,1)]"
                style={{ transitionProperty: 'background, color, box-shadow, transform' }}
                onClick={() => setMenuOpen(false)}
              >
                Launch App
              ...
              <Link
                to="/app"
                className="w-11/12 text-center py-3 rounded-full text-lg font-semibold text-[#007d40] hover:text-[#fffae2] hover:bg-gradient-to-r hover:from-[#007d40] hover:to-[#0097b2] hover:shadow-2xl hover:scale-105 transition-all duration-450 ease-[cubic-bezier(0.4,0,0.2,1)]"
                style={{ transitionProperty: 'background, color, box-shadow, transform' }}
                onClick={() => setMenuOpen(false)}
              >
                Sign In
